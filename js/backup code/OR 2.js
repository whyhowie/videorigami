...
OR.Command = function (modele) {
  var model = modele; // Since modele is an object, this is a reference assignment
  ...
  const rollBack = () => {
    ...
    // commandLoop()
    // console.log(this.cmdList)
    // this.cmdList = this.origCmdList
    // console.log(this.cmdList.join('\n'))
    // command(this.cmdList.join('\n'))
  

    // this.cmdList = this.origCmdList // Replace the command list with original
    // console.log("Still here! " + this.currentCmd)
    // model.change = true
